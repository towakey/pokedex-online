  ...
  <v-row>
    ...
    <v-container>
          ...
          <v-row>
            ...
            >
              ...
              >
                ...
                class=""
                >
                  <h2 class="responsive-text-name">{{ pokedex[index].name.jpn }}</h2>
                </v-card-title>
              </v-card>
              <v-card
              elevation="0"
              ...
              >
                ...
                class=""
                >
                  <div class="responsive-text">分類　　　　　{{ pokedex[index].classification }}</div>
                </v-card-title>
              </v-card>
              <v-card
              elevation="0"
              ...
              >
                ...
                class=""
                >
                  <div class="responsive-text">図鑑番号　　　No.{{ ('0000' + pokedex[index].no).slice(-4) }}</div>
                </v-card-title>
              </v-card>
              <v-card
              elevation="0"
              ...
              >
                ...
                class=""
                >
                  <NuxtLink class="nuxtlink" :to="{path: `/pokedex/global/${pokedex[index].globalNo}`}">
                  <div class="responsive-text">全国図鑑番号　No.{{ ('0000' + pokedex[index].globalNo).slice(-4) }}</div>
                  </NuxtLink>
                </v-card-title>
              </v-card>
              <v-card
              ...
              >
                ...
                class=""
                >
                  <div class="responsive-text">たかさ<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M18.5 1.586L22.914 6L21.5 7.414l-2-2v13.172l2-2L22.914 18L18.5 22.414L14.086 18l1.414-1.414l2 2V5.414l-2 2L14.086 6zM2 2h10v20H2zm2 2v16h6V4z"/></svg>　　　{{ pokedex[index].height }} m</div>
                </v-card-title>
              </v-card>
              <v-card
              elevation="0"
      ...
      >
        ...
        >
          <TypeView :pokedex="pokedex[index]" :area="route.params.area" />
          <StatusChart :statusData="pokedex[index]" />
          <AbilityView :pokedex="pokedex[index]" :area="route.params.area" />
          <DescriptionView :description="pokedex[index].description" :title="metaTitle" />
          <wazaView :wazaData="pokedex[index]" :area="route.params.area" />
          <evolveView :evolveData="pokedex[index]" :area="route.params.area" />
          <v-card
          elevation="0"
          style="margin-top: 20px;background-color: white;"
          variant="outlined"
